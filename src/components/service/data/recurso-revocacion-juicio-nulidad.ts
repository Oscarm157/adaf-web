...
const data: ServiceData = {
  ...
  metaDescription:
    "Impugnación de resoluciones de autoridades fiscales y administrativas. Recurso de revocación ante SAT y juicio contencioso ante TFJA. Despacho ADAF en Tijuana.",
};
