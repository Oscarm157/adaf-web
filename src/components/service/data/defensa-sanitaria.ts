...
const data: ServiceData = {
  ...
  metaDescription:
    "Defensa contra sanciones sanitarias federales (COFEPRIS) y estatales (COEPRIS Baja California): multas, suspensiones de actividad y aseguramiento de producto. Despacho ADAF en Tijuana.",
};
