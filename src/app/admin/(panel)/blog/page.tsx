  ...
  return (
    <div className="crm-fade mx-auto max-w-[1280px] px-4 py-8 sm:px-7">
      <PageHeader
        eyebrow="Contenido"
        title="Blog"
        description="Notas del blog público de ADAF. Se editan aquí y aparecen en /blog al publicarlas."
      />
      ...
      {rows.length === 0 ? (
        <div className="crm-empty px-6 py-20">
          ...
          <p className="mt-1 max-w-xs text-[13px] text-[var(--crm-ink-mute)]">
            Crea la primera y redáctala con la convención de markdown del blog.
          </p>
